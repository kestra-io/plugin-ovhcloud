package io.kestra.plugin.ovhcloud;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.ovhcloud.OvhcloudTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class OvhcloudTask extends Task implements RunnableTask<OvhcloudTask.Output> {
    @Schema(
    ...
    @Override
    public OvhcloudTask.Output run(RunContext runContext) throws Exception {
